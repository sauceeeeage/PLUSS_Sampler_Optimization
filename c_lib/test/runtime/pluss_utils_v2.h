#ifndef PLUSS_UTILS_V2_H
#define PLUSS_UTILS_v2_H
#include <assert.h>
#include <cmath>
#include <array>
#include <vector>
...
extern std::array<phmap::flat_hash_map<int, Histogram>, THREAD_NUM> _SharePRI;
...
{
	_pluss_histogram_update(_NoSharePRI[tid], reuse, count, false);
}
